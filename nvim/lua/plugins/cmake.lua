...
return {
  ...
  cmake_build_options = {'-j250'}, -- this will be passed when invoke `CMakeBuild`
  -- support macro expansion:
  --       ${kit}
  --       ${kitGenerator}
  --       ${variant:xx}
  cmake_build_directory = "../build-relwithdebinfo", -- this is used to specify generate directory for cmake, allows macro expansion, relative to vim.loop.cwd()
...
vim.cmd("command! CMakeTargetSelect lua select_cmake_target()")
